...
def train_anomaly_detector(df_filtered):
    ...
    try:
        ...
        model_gb = GradientBoostingClassifier(n_estimators=10,n_jobs=-1, random_state=42)
        ...
        print("\n=== ENTRENANDO LIGHTGBM ===")
        model_lgbm = LGBMClassifier(n_estimators=10, random_state=42)
        ...
        print("\n=== ENTRENANDO XGBOOST ===")
        model_xgb = XGBClassifier(n_estimators=10, use_label_encoder=False, eval_metric='logloss', random_state=42)
