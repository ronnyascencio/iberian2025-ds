...
def train_anomaly_detector(df_filtered):
    ...
    def train_and_evaluate_model(X_train, y_train, X_test, y_test, sample_weight):
        print("\n=== ENTRENANDO XGBOOST ===")
        param_grid = {
            'max_depth': [2, 4],
    ...
    try:
        ...
        model, y_pred_xgb = train_and_evaluate_model(X_train, y_train, X_test, y_test, sample_weight)
