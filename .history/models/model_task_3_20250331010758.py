...
def train_anomaly_detector(df_filtered):
    ...
    try:
        ...
        for clase in unique_classes:
            ...
            X_clase = df_features[[col for col in selected_features if col in df_features.columns]]

            X_train_bin, X_test_bin, y_train_bin, y_test_bin = train_test_split(X_clase, y_bin, test_size=0.3, random_state=42)
