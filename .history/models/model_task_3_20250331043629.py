...
def train_anomaly_detector(df_filtered):
    ...
    try:
        ...
        model, anomalies = new_func(df_features, le, X, X_train, X_test, y_train, y_test, sample_weight, grid_model, sample_idx)
...
def new_func(df_features, le, X, X_train, X_test, y_train, y_test, sample_weight, grid_model, sample_idx):
