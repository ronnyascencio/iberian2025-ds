...
def train_anomaly_detector(df_filtered):
    ...
    try:
        ...
        for clase in np.unique(y_train):
            ...
            X_bin, X_train_bin, X_test_bin, y_train_bin, y_test_bin, grid_model_bin = new_func(df_features, y, eachfeatures, i, clase)
...
def new_func(df_features, y, eachfeatures, i, clase):
