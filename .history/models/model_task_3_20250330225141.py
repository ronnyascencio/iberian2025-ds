...
def prepare_features(df):
    ...
    df_features["combined_score"] = (
        df_features["avg_value"] * 0.1712 +
        df_features["CO"] * 0.0372 +
        df_features["PM10"] * 0.2581 +
        
        df_features["rolling_std_10h"]*0.2947  +
        df_features["rolling_std_10h"] *0.1229 +
        df_features["rolling_std_3h"] *0.1159
