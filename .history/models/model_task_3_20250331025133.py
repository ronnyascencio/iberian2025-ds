...
def train_anomaly_detector(df_filtered):
    ...
    try:
        ...
        for clase in np.unique(y_train):
            ...
            shap_values_bin = explainer_bin(X_test_bin.sample(min(1000000, len(X_test_bin)), random_state=42))
        ...
        shap_values = explainer(X_test.sample(min(1000000, len(X_test)), random_state=42))
