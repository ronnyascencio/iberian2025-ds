...
def prepare_features(df):
    ...
    df_features["rolling_mean_10h"] = df_features["Average value"].rolling(window=3, min_periods=1).mean()
    df_features["rolling_std_10h"] = df_features["Average value"].rolling(window=3, min_periods=1).std()
