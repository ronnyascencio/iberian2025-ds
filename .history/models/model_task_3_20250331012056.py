...
def train_anomaly_detector(df_filtered):
    ...
    try:
        ...
        eachfeatures= [["Average value", "CO", "PM10", "rolling_std_10h","SO2","PM2.5"],
                       ["Average value", "CO", "PM10", "rolling_std_10h","SO2","PM2.5"],
                       ["Average value", "CO", "PM10", "rolling_std_10h","SO2","PM2.5"],
                       ["Average value", "CO", "PM10", "rolling_std_10h","SO2","PM2.5"],
                       ["Average value", "CO", "PM10", "rolling_std_10h","SO2","PM2.5"]
        ]
        ...
        for clase in np.unique(y_train):
            ...
            X = df_features[[col for col in eachfeatures[i] if col in df_features.columns]]

            X_train, X_test, y_train, y_test = train_test_split(X, y_train_bin, test_size=0.3, random_state=42)
